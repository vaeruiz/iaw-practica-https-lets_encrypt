...
# Instalar/actualizar snapd
snap install core; sudo snap refresh core

# Eliminar instalaciones anteriores de Certbot
apt-get remove certbot

# Instalar Certbot
snap install --classic certbot

# Crear alias para el uso de Certbot
ln -s /snap/bin/certbot /usr/bin/certbot

# Obtener el certificado para nuestro sitio
certbot --apache -m correo@demo.es --agree-tos --no-eff-email -d nombre_dominio(ej. iaw-rcap.tk)
